...
import { AboutContentWrapper } from "./AboutContent.styles";
...
const AboutContent = (props) => {
  return (
    <AboutContentWrapper>
      ...
      <div className="desc">
        Это сердце пространства, которое ежедневно одаривает пользователей
        монетами, часть из которых конвертируется в опыт, позволяя получить
        максимум бонусов от компании. Остальные монеты сотрудник может обменять
        на мерчевые вещи в Вендомате или поделиться ими с другом. Также в
